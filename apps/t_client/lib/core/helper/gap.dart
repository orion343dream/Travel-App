...
/// Class that return SizedBox and maintains vertical
/// spacing
class VerticalGap {
  ...
  static const l = SizedBox(height: 16);

  /// Creates SizedBox with height 20
  static const xl = SizedBox(height: 20);
...
class HorizontalGap {
  ...
  /// Creates SizedBox with width 12
  static const m = SizedBox(width: 12);

  /// Creates SizedBox with width 16
  static const l = SizedBox(width: 16);

  /// Creates SizedBox with width 20
  static const xl = SizedBox(width: 20);
