...
class _$SearchImpl implements Search {
  ...
  @override
  String toString() {
    return 'SearchEvent.search(search: $search)';
  }
...
abstract class Search implements SearchEvent {
  const factory Search({required final String search}) = _$SearchImpl;
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl({required final List<TravelPackageModel> packages})
      : _packages = packages;
  ...
  @override
  String toString() {
    return 'SearchState.loaded(packages: $packages)';
  }
...
abstract class Loaded implements SearchState {
  const factory Loaded({required final List<TravelPackageModel> packages}) =
      _$LoadedImpl;
