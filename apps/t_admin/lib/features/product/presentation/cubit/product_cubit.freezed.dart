...
mixin _$ProductState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String succesMessage) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String succesMessage)? success,
...
class _$ProductSuccessImpl
    with DiagnosticableTreeMixin
    implements ProductSuccess {
  const _$ProductSuccessImpl({required this.succesMessage});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProductState.success(succesMessage: $succesMessage)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('succesMessage', succesMessage));
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, succesMessage);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(succesMessage);
  }
...
abstract class ProductSuccess implements ProductState {
  const factory ProductSuccess({required final String succesMessage}) =
